...
{
    public partial class fAnyadirAlumno : Form
    {
        ...
        public fAnyadirAlumno(SqlDBHelper conexion)
        {
            InitializeComponent();
            conexionDB = conexion;
        ...
        private void fAnyadirAlumno_Load(object sender, EventArgs e)
        {
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            if (ValidarEjecucion())
            {
                ...
                conexionDB.AnyadirAlumno(campos);
                this.Close();
            }
            else
            {
