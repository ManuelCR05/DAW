...
{
    public partial class fAnyadirProfesor : Form
    {
        private SqlDBHelper conexionDB;
        private string dni, nombre, apellido1, apellido2 = "", telefono, email, contrasenya, codCurso;
        private List<string> campos;
        private List<Control> listaCampos;

        public fAnyadirProfesor(SqlDBHelper conexion)
        {
            InitializeComponent();
            conexionDB = conexion;
        ...
        private void fAnyadirProfesor_Load(object sender, EventArgs e)
        {
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            if (ValidarEjecucion())
            {
                ...
                conexionDB.AnyadirProfesor(campos);
                this.Close();
            }
            else
            {
